...
CREATE TABLE
    IF NOT Exists Usuarios(
        ...
        imgPerfil VARCHAR(150) DEFAULT "https://thumbs.dreamstime.com/b/icono-del-vector-perfil-de-la-cara-avatar-miembro-usuario-125994581.jpg",
...
ALTER TABLE Usuarios MODIFY COLUMN correo VARCHAR(50) UNIQUE NOT NULL;

ALTER TABLE Usuarios MODIFY COLUMN pais VARCHAR(50) NOT NULL DEFAULT "ecuador" ;
...
/*No nulo*/
ALTER TABLE
    Usuarios MODIFY COLUMN usuario VARCHAR(90) NOT NULL;
